            ...
            <div key={hacker.id} className="col-12 col-md-5 m-1">
                <Card className="">
                    ...
                    <div>
                        ...
                        <div>
                            <b>Overall Percentile: </b> {((hacker.competitivePercentile.dataStructures + hacker.competitivePercentile.algorithms + hacker.competitivePercentile.cpp + hacker.competitivePercentile.java + hacker.competitivePercentile.python + hacker.competitivePercentile.html + hacker.competitivePercentile.javascript) / 7).toFixed(2)}
                        </div>
                        <div>
                            <table>
                                <tr>
